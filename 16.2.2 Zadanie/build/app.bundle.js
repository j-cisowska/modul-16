	...
	_createClass(App, [{
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(_Title2.default, { title: this.title, add: this.state.data.length })
			);
		}
	}]);
...
var TodoList = function TodoList(props) {
  return _react2.default.createElement('ul', { className: _TodoList2.default.TodoList });
};
